...
import com.example.starBank.repositories.DinamicRuleRepository;
...
public class SimpleCreditRuleService {
    ...
    private DinamicRuleRepository dinamicRuleRepository;
    ...
    public SimpleCreditRuleService(DinamicRuleRepository dinamicRuleRepository,
                                   RecommendationsRuleRepository recommendationsRuleRepository,
                                   RuleRequirementsRepository ruleRequirementsRepository) {
        this.dinamicRuleRepository = dinamicRuleRepository;
    ...
    public boolean recommendationSimpleCredit(UUID id, RecommendationWithRules recom) {
        ...
        if (userOf.get().isNegate()) {
            ...
            Boolean queryTransWithdrad = dinamicRuleRepository.getTransactionSumCompareDepositWithDrawResult(id, arg);
            ...
            if (queryTransWithdrad && !transactionSum.get().isNegate()) {
                ...
                Boolean queryTrans = dinamicRuleRepository.getTransactionSumCompareResult(id, arg2);
