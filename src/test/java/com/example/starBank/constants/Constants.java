...
public class Constants {
    ...
    public static final Recommendation INVEST500 = new Recommendation(UUID.randomUUID(), "Invest 500", "Откройте свой путь к успеху с индивидуальным" +
    ...
    public static final Recommendation SIMPLECREDIT = new Recommendation(UUID.randomUUID(), "Простой кредит", "Откройте мир выгодных кредитов с нами!\n" +
            "\n" +
    ...
    public static final Recommendation TOPSAVING = new Recommendation(UUID.randomUUID(), "Top saving", "Откройте свою собственную «Копилку» с нашим банком! «Копилка» — " +
